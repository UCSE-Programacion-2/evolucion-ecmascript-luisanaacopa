...
function explicarConcurrenciaYParalelismo() {
  ...
  return {
    concurrencia:
      'es la capacidad de ejecutar múltiples tareas en un solo hilo de ejecución, alternando entre ellas.',
    paralelismo:
      'es la capacidad de ejecutar múltiples tareas simultáneamente en diferentes hilos o procesos.',
  };
}
